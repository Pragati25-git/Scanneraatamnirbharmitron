...
public class ScannerAatamnirbharMitron extends AppCompatActivity implements MainActivity {
    EditText mResultEt;
    ...
    private void pickCamera() {
        //intent to take image from camera, it will also save to storage to get high quality
            ...
            if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    if (!recognizer.isOperational()) {
                        ...
                        //get text from ab until there is no txt
                        for (int i = 0; i < items.size(); i++) {
                            TextBlock myItem = items.valueAt(i);
                            sb.append(myItem = items.valueAt(i));
